...
- Follow the python best practicies
- Follow pep8 definition
- Follow functional paradigm
    - Follow this rules bellow to write code:
        - Identation rules:
            - Only One Level Of Indentation Per Loop
                - If is really necessary add a new one, create a new function to do that
            - Maximum of 2 level of indentation conditionals
            - Maximum of 3 levels of indentation per functions
        - Don’t Use The ELSE Keyword
            - Always do early return
        - One Dot Per Line
            - One method call per line, do not do chain call in a single line:
                - Do not: `foo.bar.something()`
